...
public class InstanceOfTest {
	public static void main(String[] args) {
		...
		if (str instanceof String) {
			System.out.println("The str is a String.");
		}
		if (str instanceof StringBuffer) {
			System.out.println("The str is a StringBuffer.");
		}
		if (str instanceof Object) {
			System.out.println("The str is a Object.");
		}

		Object obj = null;
		if (!(obj instanceof Object)) {
			System.out.println("The null is not a Object.");
		}
	}
}
