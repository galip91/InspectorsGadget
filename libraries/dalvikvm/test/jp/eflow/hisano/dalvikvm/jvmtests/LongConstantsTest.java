...
public class LongConstantsTest {
	// lconst_*が使われるように定数を使っています
	// ldc_2wも同時にテスト
	public static void main(String[] args) {
		long value1 = 1;
		System.out.println("<NUM VAL=" + value1 + ">");
		
		long value2 = 2;
		System.out.println("<NUM VAL=" + value2 + ">");
		
		long value3 = 3;
		System.out.println("<NUM VAL=" + value3 + ">");
	}
}
